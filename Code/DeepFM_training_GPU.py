...
from model01_deepFM import ClickClassifier
...
def train(data_path, category_count, category_dim, device):
    ...
    model = ClickClassifier(category_count, category_dim).to(device) 
...
if __name__ == "__main__":
    ...
    models_dir = "/home/ubuntu/yhu/DeepFM_with_PyTorch_https/Models"
    ...
    print("model_epoch_3_iter_6000.pth, val_loss: ",val_loss, "auc", auc_score)  # model_epoch_3_iter_6000.pth, val_loss:  0.46762518763542177 auc_scores 0.790065851988272
